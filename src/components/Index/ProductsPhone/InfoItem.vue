<template>
  <div class="infowrapper">
    ...
    <div v-for="item in props.infos" :key="item.subtitle">
      <div class="subtitle">
    ...
    <!-- <a :href="`mailto:${emails.name1}?subject=about products`">
      <div class="contact">
        {{ props.contact }}
        <svg-icon
          name="arrow-blue"
...
.infowrapper {
  ...
  .desc {
    ...
    margin-left: calc(0.6rem + 1.25rem);
    margin-top: 0.25rem;
  }
  // .contact {
  //   color: #007bff;
